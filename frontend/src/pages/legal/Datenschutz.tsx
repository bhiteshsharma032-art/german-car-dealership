  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 text-gray-300 leading-relaxed">
      ...
      <Card variant="elevated" className="p-8">
        ...
        <h3 className="text-lg font-bold text-white mt-6 mb-2">Datenerfassung auf dieser Website</h3>
        ...
        <p className="font-semibold text-white mb-2">Welche Rechte haben Sie bezüglich Ihrer Daten?</p>
        ...
        <h3 className="text-lg font-bold text-white mt-6 mb-2">Analyse-Tools und Tools von Drittanbietern</h3>
      ...
      <Card variant="elevated" className="p-8">
        <h2 className="text-2xl font-bold text-white mb-6">2. Hosting</h2>
        <h3 className="text-lg font-bold text-white mb-2">Strato</h3>
      ...
      <Card variant="elevated" className="p-8">
        ...
        <h3 className="text-lg font-bold text-white mt-6 mb-2">Datenschutz</h3>
        ...
        <h3 className="text-lg font-bold text-white mt-6 mb-2">Hinweis zur verantwortlichen Stelle</h3>
        <p className="mb-2">Die verantwortliche Stelle für die Datenverarbeitung auf dieser Website ist:</p>
        <div className="bg-zinc-800/50 p-4 rounded-lg text-gray-300 mb-4">
        ...
        <h3 className="text-lg font-bold text-white mt-6 mb-2">Speicherdauer</h3>
        <p className="mb-4">Soweit innerhalb dieser Datenschutzerklärung keine speziellere Speicherdauer genannt wurde, verbleiben Ihre personenbezogenen Daten bei uns, bis der Zweck für die Datenverarbeitung entfällt. Wenn Sie ein berechtigtes Löschersuchen geltend machen oder eine Einwilligung zur Datenverarbeitung widerrufen, werden Ihre Daten gelöscht, sofern wir keine anderen rechtlich zulässigen Gründe für die Speicherung Ihrer personenbezogenen Daten haben (z. B. steuer- oder handelsrechtliche Aufbewahrungsfristen); im letztgenannten Fall erfolgt die Löschung nach Fortfall dieser Gründe.</p>

        <h3 className="text-lg font-bold text-white mt-6 mb-2">Allgemeine Hinweise zu den Rechtsgrundlagen der Datenverarbeitung auf dieser Website</h3>
        ...
        <h3 className="text-lg font-bold text-white mt-6 mb-2">Empfänger von personenbezogenen Daten</h3>
        ...
        <h3 className="text-lg font-bold text-white mt-6 mb-2">Widerruf Ihrer Einwilligung zur Datenverarbeitung</h3>
        ...
        <h3 className="text-lg font-bold text-white mt-6 mb-2">Widerspruchsrecht gegen die Datenerhebung in besonderen Fällen sowie gegen Direktwerbung (Art. 21 DSGVO)</h3>
        ...
        <h3 className="text-lg font-bold text-white mt-6 mb-2">Beschwerderecht bei der zuständigen Aufsichtsbehörde</h3>
        <p className="mb-4">Im Falle von Verstößen gegen die DSGVO steht den Betroffenen ein Beschwerderecht bei einer Aufsichtsbehörde, insbesondere in dem Mitgliedstaat ihres gewöhnlichen Aufenthalts, ihres Arbeitsplatzes oder des Orts des mutmaßlichen Verstoßes zu. Das Beschwerderecht besteht unbeschadet anderweitiger verwaltungsrechtlicher oder gerichtlicher Rechtsbehelfe.</p>

        <h3 className="text-lg font-bold text-white mt-6 mb-2">Recht auf Datenübertragbarkeit</h3>
        <p className="mb-4">Sie haben das Recht, Daten, die wir auf Grundlage Ihrer Einwilligung oder in Erfüllung eines Vertrags automatisiert verarbeiten, an sich oder an einen Dritten in einem gängigen, maschinenlesbaren Format aushändigen zu lassen. Sofern Sie die direkte Übertragung der Daten an einen anderen Verantwortlichen verlangen, erfolgt dies nur, soweit es technisch machbar ist.</p>

        <h3 className="text-lg font-bold text-white mt-6 mb-2">Auskunft, Berichtigung und Löschung</h3>
        ...
        <h3 className="text-lg font-bold text-white mt-6 mb-2">Recht auf Einschränkung der Verarbeitung</h3>
        ...
        <h3 className="text-lg font-bold text-white mt-6 mb-2">SSL- bzw. TLS-Verschlüsselung</h3>
      ...
      <Card variant="elevated" className="p-8">
        ...
        <h3 className="text-lg font-bold text-white mt-6 mb-2">Server-Log-Dateien</h3>
        ...
        <h3 className="text-lg font-bold text-white mt-6 mb-2">Kontaktformular</h3>
        ...
        <h3 className="text-lg font-bold text-white mt-6 mb-2">Einsatz von KI auf der Website</h3>
        ...
        <h3 className="text-lg font-bold text-white mt-6 mb-2">Anfrage per E-Mail, Telefon oder Telefax</h3>
        ...
        <h3 className="text-lg font-bold text-white mt-6 mb-2">Einsatz von Chatbots</h3>
        ...
        <h3 className="text-lg font-bold text-white mt-6 mb-2">Einsatz von KI-Anwendungen im Rahmen der Chatbot-Kommunikation</h3>
      ...
      <Card variant="elevated" className="p-8">
        <h2 className="text-2xl font-bold text-white mb-6">6. Plugins und Tools</h2>
        <h3 className="text-lg font-bold text-white mb-2">Google Fonts</h3>
      ...
      <Card variant="elevated" className="p-8">
        <h2 className="text-2xl font-bold text-white mb-6">7. eCommerce und Zahlungsanbieter</h2>
        <h3 className="text-lg font-bold text-white mb-2">Verarbeiten von Kunden- und Vertragsdaten</h3>
      ...
      <div className="mt-8 pt-8 border-t border-zinc-800 text-center text-sm text-gray-500 pb-20">
        <p>Stand: März 2026</p>
...
function DatenschutzEN() {
  return (
    <div className="max-w-4xl mx-auto space-y-8 text-gray-300 leading-relaxed">
      ...
      <Card variant="elevated" className="p-8">
        <h2 className="text-2xl font-bold text-white mb-6">1. An overview of data protection</h2>
        <h3 className="text-lg font-bold text-white mb-2">General information</h3>
        <p className="mb-4">The following information will provide you with an easy to navigate overview of what will happen with your personal data when you visit this website. The term “personal data” comprises all data that can be used to personally identify you. For detailed information about the subject matter of data protection, please consult our Data Protection Declaration, which we have included beneath this copy.</p>

        <h3 className="text-lg font-bold text-white mt-6 mb-2">Data recording on this website</h3>
        <p className="font-semibold text-white mb-2">Who is the responsible party for the recording of data on this website (i.e., the “controller”)?</p>
        ...
        <p className="font-semibold text-white mb-2">How do we record your data?</p>
        ...
        <p className="font-semibold text-white mb-2">What are the purposes we use your data for?</p>
        ...
        <p className="font-semibold text-white mb-2">What rights do you have as far as your information is concerned?</p>
        ...
        <h3 className="text-lg font-bold text-white mt-6 mb-2">Analysis tools and tools provided by third parties</h3>
      ...
      <Card variant="elevated" className="p-8">
        <h2 className="text-2xl font-bold text-white mb-6">3. General information and mandatory information</h2>
        <h3 className="text-lg font-bold text-white mt-6 mb-2">Data protection</h3>
        ...
        <h3 className="text-lg font-bold text-white mt-6 mb-2">Information about the responsible party (Controller)</h3>
        ...
        <h3 className="text-lg font-bold text-white mt-6 mb-2">Storage duration</h3>
        <p className="mb-4">Unless a more specific storage period has been specified in this privacy policy, your personal data will remain with us until the purpose for which it was collected no longer applies. If you assert a justified request for deletion or revoke your consent to data processing, your data will be deleted, unless we have other legally permissible reasons for storing your personal data (e.g., tax or commercial law retention periods); in the latter case, the deletion will take place after these reasons cease to apply.</p>

        <h3 className="text-lg font-bold text-white mt-6 mb-2">General information on the legal basis for the data processing on this website</h3>
        ...
        <h3 className="text-lg font-bold text-white mt-6 mb-2">Recipients of personal data</h3>
        ...
        <h3 className="text-lg font-bold text-white mt-6 mb-2">Revocation of your consent to the processing of data</h3>
        ...
        <h3 className="text-lg font-bold text-white mt-6 mb-2">Right to object to the collection of data in special cases; right to object to direct advertising (Art. 21 GDPR)</h3>
        ...
        <h3 className="text-lg font-bold text-white mt-6 mb-2">Right to log a complaint with the competent supervisory agency</h3>
        <p className="mb-4">In the event of violations of the GDPR, data subjects are entitled to log a complaint with a supervisory agency, in particular in the member state where they usually maintain their domicile, place of work or at the place where the alleged violation occurred. The right to log a complaint is in effect regardless of any other administrative or court proceedings available as legal recourses.</p>

        <h3 className="text-lg font-bold text-white mt-6 mb-2">Right to data portability</h3>
        <p className="mb-4">You have the right to have data that we process automatically on the basis of your consent or in fulfillment of a contract handed over to you or to a third party in a common, machine-readable format. If you should demand the direct transfer of the data to another controller, this will be done only if it is technically feasible.</p>

        <h3 className="text-lg font-bold text-white mt-6 mb-2">Information about, rectification and eradication of data</h3>
        <p className="mb-4">Within the scope of the applicable statutory provisions, you have the right to demand information about your archived personal data, their source and recipients as well as the purpose of the processing of your data at any time. You may also have a right to have your data rectified or eradicated. If you have questions about this subject matter or any other questions about personal data, please do not hesitate to contact us at any time.</p>

        <h3 className="text-lg font-bold text-white mt-6 mb-2">Right to demand processing restrictions</h3>
        ...
        <h3 className="text-lg font-bold text-white mt-6 mb-2">SSL and/or TLS encryption</h3>
        <p className="mb-4">For security reasons and to protect the transmission of confidential content, such as purchase orders or inquiries you submit to us as the website operator, this website uses either an SSL or a TLS encryption program. You can recognize an encrypted connection by checking whether the address line of the browser switches from “http://” to “https://” and also by the appearance of the lock icon in the browser line. If the SSL or TLS encryption is activated, data you transmit to us cannot be read by third parties.</p>
      </Card>

      <Card variant="elevated" className="p-8">
        <h2 className="text-2xl font-bold text-white mb-6">4. Recording of data on this website</h2>
        <h3 className="text-lg font-bold text-white mt-6 mb-2">Server log files</h3>
        ...
        <h3 className="text-lg font-bold text-white mt-6 mb-2">Contact form</h3>
        ...
        <h3 className="text-lg font-bold text-white mt-6 mb-2">Use of AI on the website</h3>
        ...
        <h3 className="text-lg font-bold text-white mt-6 mb-2">Request by e-mail, telephone, or fax</h3>
        ...
        <h3 className="text-lg font-bold text-white mt-6 mb-2">Use of Chatbots</h3>
        ...
        <h3 className="text-lg font-bold text-white mt-6 mb-2">Use of AI applications in the context of chatbot communication</h3>
      ...
      <Card variant="elevated" className="p-8">
        <h2 className="text-2xl font-bold text-white mb-6">5. Social media</h2>
        <h3 className="text-lg font-bold text-white mb-2">Instagram</h3>
      ...
      <Card variant="elevated" className="p-8">
        <h2 className="text-2xl font-bold text-white mb-6">6. Plug-ins and Tools</h2>
        <h3 className="text-lg font-bold text-white mb-2">Google Fonts</h3>
      ...
      <Card variant="elevated" className="p-8">
        <h2 className="text-2xl font-bold text-white mb-6">7. eCommerce and payment service providers</h2>
        <h3 className="text-lg font-bold text-white mb-2">Processing of Customer and Contract Data</h3>
