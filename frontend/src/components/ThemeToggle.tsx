...
export default function ThemeToggle() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
      {/* Color Theme Picker */}
      {showColorPicker && (
        <div className="bg-[#22222a] rounded-lg shadow-xl p-3 border border-[#2e2e38] animate-fadeIn">
      ...
      <button
        ...
        className="w-12 h-12 rounded-full bg-[#22222a] shadow-lg hover:shadow-red-600/20 transition-all flex items-center justify-center border border-[#2e2e38] hover:scale-110 ml-auto"
