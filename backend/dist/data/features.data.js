...
exports.getFeatureById = exports.getFeaturesByCategory = exports.carFeatures = void 0;
exports.carFeatures = [
    // Comfort Features
...
const getFeaturesByCategory = (category) => {
    return exports.carFeatures.filter(f => f.category === category);
};
exports.getFeaturesByCategory = getFeaturesByCategory;
const getFeatureById = (id) => {
    return exports.carFeatures.find(f => f.id === id);
};
